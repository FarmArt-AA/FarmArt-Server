...
public class UpdateDesignerProfileImageDto {
    ...
    public static class Request {
        ...
        @Schema(description = "디자이너 프로필 이미지 필수", required = true, type = "file")
    ...
    public static class Response {
        ...
        @Schema(description = "디자이너 프로필 PK")
        private Long farmerProfileId;

        @Schema(description = "디자이너 프로필 이미지")
        private String path;
